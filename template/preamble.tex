...
\DeclareFieldFormat{doi}{%
 \newline
  \color{pciblue}{\underline{\ifhyperref
...
\lhead{\ifnum\thepage=1 \includegraphics[width=13.5cm]{resources/logo_pour_PDF_\whichPCI.png} \else \includegraphics[width=5cm]{resources/small_logo_pour_PDF_\whichPCI.png} \fi}\chead{}
\rhead{}
\cfoot{}
\rfoot{}
...
\vspace*{15pt}
\includegraphics[align=c,width=0.5cm]{resources/OAlogoblue.png} \space \large{\color{pciblue}Open Access}\\

\includegraphics[align=c,width=0.5cm]{resources/o_data3.png} \space \large{\color{pciblue}Open Data}{}
\\
\includegraphics[align=c,width=0.5cm]{resources/o_script3.png} \space \large{\color{pciblue}Open Code}{}
\\
\includegraphics[align=c,width=0.5cm]{resources/o_peerreview.png} \space \large{\color{pciblue}Open Peer-Review}\\
\raggedleft
\vspace*{1cm}
%\vspace*{3.25cm}
...
{\color{pciblue}\fullcite{recommendedpreprint}\mybibexclude{recommendedpreprint}}\\
...
\centering\large{\fontseries{sb}\selectfont{This version of the article has been peer-reviewed and recommended by\\
\emph{\PCI}\\
\recommendationDOI\\}}
